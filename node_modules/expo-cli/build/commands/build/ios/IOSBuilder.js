...
class IOSBuilder extends _BaseBuilder().default {
  ...
  async checkProjectConfig() {
    ...
    if (!bundleIdentifier) {
      ...
      const bundleIdPrompt = await (0, _prompt().default)([{
      ...
      const modification = await (0, _config().modifyConfigAsync)(this.projectDir, {
        ios: {
          bundleIdentifier: bundleIdPrompt.bundleIdentifier
        }
      }, {
      ...
      if (modification.type === 'success') {
        _log().default.newLine(); // Success!


        (0, _log().default)(`Your iOS bundle identifier is now: ${bundleIdPrompt.bundleIdentifier}`);
        ...
        if (modification.type === 'warn') {
          ...
          (0, _log().default)(_log().default.chalk.yellow(modification.message));
        } else {
