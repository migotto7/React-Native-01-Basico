...
async function upgradeAsync({
  ...
  let devDependencies = (0, _pickBy().default)(updates, (_version, name) => {
  ...
  let dependencies = (0, _pickBy().default)(updates, (_version, name) => {
  ...
  let untouchedDependencies = (0, _difference().default)(Object.keys(allDependencies), [...Object.keys(updates), 'expo']);
  ...
  let skippedSdkVersions = (0, _pickBy().default)(sdkVersions, (_data, sdkVersionString) => {
